                    ...
                    <div className="w-full md:w-[40%]">
                        <div className="flex flex-col justify-center items-center border-[1.5px] border-black/20 dark:border-white/20 p-2 rounded-md max-w-md lg:h-[27rem] mx-auto py-4 px-6">
                            ...
                            <div className="w-full pt-8">
                                <a
                                    href="https://www.fiverr.com/topu_web_dev"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    <button
                                        type="button"
                                        className="w-full py-2 border-[1.5px] border-black/20 dark:border-white/20 dark:border-white text-center rounded-md"
                                    >
                                        Preview Profile
                                    </button>
                                </a>
                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            ...
                            >
                                <span className="self-start text-2xl  whitespace-nowrap dark:text-white font-bold">
                                    TOPU ROY
                                </span>
                                <span className="self-start text-sm whitespace-nowrap dark:text-white">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    ...
                                    <li>
                                        <a
                                            href="https://www.linkedin.com/in/topu-roy/"
                                            className="hover:underline"
                                        >
                                            Linkedin
                                        </a>
